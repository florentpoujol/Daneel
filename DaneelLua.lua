...
function Daneel.Lua.math.isinteger(number, strict)
...
function Daneel.Lua.string.totable(s)
...
function Daneel.Lua.string.isoneof(s, t, ignoreCase)
...
function Daneel.Lua.string.ucfirst(s)
...
Daneel.Lua.table.__index = Daneel.Lua.table
...
function Daneel.Lua.table.new(...)
    ...
    t = setmetatable(t, Daneel.Lua.table)
...
function Daneel.Lua.table.copy(t)
...
function Daneel.Lua.table.containskey(t, p_key)
...
function Daneel.Lua.table.containsvalue(t, p_value, ignoreCase)
...
function Daneel.Lua.table.length(t, keyType)
...
-- @param t (table) The table.
function Daneel.Lua.table.print(t)
...
-- @param t (table) The table.
function Daneel.Lua.table.printmetatable(t)
...
-- @return (table) The new table.
function Daneel.Lua.table.merge(...)
    if arg == nil then
...
function Daneel.Lua.table.compare(table1, table2)
...
function Daneel.Lua.table.combine(keys, values, strict)
...
-- @return (table) The table
function Daneel.Lua.table.removevalue(t, value, singleRemove)
...
function Daneel.Lua.table.getkeys(t)
...
function Daneel.Lua.table.getvalues(t)
...
function Daneel.Lua.table.getkey(t, value)
